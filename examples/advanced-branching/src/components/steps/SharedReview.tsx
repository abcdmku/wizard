...
export function SharedReview() {
    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-green-600 mb-2">Wizard Complete!</h2>
          <p className="text-gray-600">Thank you for exploring the branching wizard</p>
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded-lg space-y-3">
          ...
          <div className="text-sm space-y-1">
            ...
            {data.subscribe && <p className="text-green-600">✓ Subscribed to updates</p>}
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold mb-2">Review & Feedback</h2>
        <p className="text-gray-600">Complete your journey with feedback</p>
      </div>

      <div className="bg-gray-50 p-4 rounded-lg">
        <h3 className="font-semibold mb-2">Your Path Through the Wizard</h3>
      ...
      <label className="flex items-center">
        ...
        />
        <span className="text-sm">Subscribe to updates about wizard improvements</span>
      </label>
