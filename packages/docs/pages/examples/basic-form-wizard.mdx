...
This example provides a solid foundation for understanding multi-step form implementation with WizardOpus, though modernization to current API patterns is recommended for new projects.