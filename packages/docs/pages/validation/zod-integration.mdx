...
Wziard provides first-class integration with [Zod](https://zod.dev), a TypeScript-first schema validation library. This integration enables type-safe validation with automatic type inference.
