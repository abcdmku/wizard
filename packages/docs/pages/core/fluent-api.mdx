...
WizardOpus implements a comprehensive fluent API through the `WizardStep` interface, allowing you to chain operations seamlessly while maintaining full TypeScript type safety.
