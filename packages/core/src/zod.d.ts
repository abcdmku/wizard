 ...
 */
export declare function createZodValidator<T>(schema: z.ZodSchema<T>): (data: unknown, ctx: unknown) => asserts data is T;
/**
 ...
 * @returns Validation function that asserts data matches the schema
 */
export declare function createContextualZodValidator<T, C>(schemaFactory: (ctx: Readonly<C>) => z.ZodSchema<T>): (data: unknown, ctx: Readonly<C>) => asserts data is T;
/**
